...
|   3 | Missing privacy policy                      | **Enforced pending evidence.** `/privacy/` permanently redirects to `/privacy-policy/`, and the privacy-notice model refuses public policy publication without legal operator, contact, retention, analytics, rights, and approval facts. No placeholder policy was published.                                                                  |
...
2. Supply and approve the legal operator identity, privacy contact/address, retention/deletion process, and confirmed analytics/logging disclosures.
