...
9. Affiliate links are inactive until merchant status, terms date, affiliate ID, domains, allowed parameters, and channel permissions are human approved. Paid links are visibly disclosed and receive `rel="sponsored"`.
